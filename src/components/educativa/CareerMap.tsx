...
import type { CatalogCareer, CatalogCourse } from "@/modules/educativa/catalog";
...
export function CareerMap({ career, courses }: CareerMapProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {courses.length === 0 ? (
        <p className="text-sm text-[--edu-text-muted]">Todavía no hay cursos cargados para esta carrera.</p>
      ) : (
