...
export function LessonUploader({ courseId, value, onUploaded }: LessonUploaderProps) {
  ...
  async function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    // No hay callback de progreso por byte en el SDK de Storage — se simula
    // hasta 90% mientras sube y se cierra a 100% cuando confirma.
