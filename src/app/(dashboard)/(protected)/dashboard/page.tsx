    ...
    <div className="flex flex-col gap-4">
      ...
      {flags.coworking ? (
        <Card className="flex flex-wrap items-center justify-between gap-3 p-4">
          <div>
            <p className="text-[14px] font-semibold text-white">Conocé Coworking INCADE</p>
            <p className="text-[13px] text-[--edu-text-muted]">Espacios y salas por hora en nuestras sedes de Posadas.</p>
          </div>
